		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.697917,0.564802,0.106542,1.000000);//Water Colour
	Material.VectorExpressions[3] = float4(0.697917,0.564802,0.106542,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[2] = float4(0.100000,1.800000,0.782232,0.680952);//Rough Fresnel Power Opacity Side Opacity Front
